const preferences={enabled:true,provider:'web',language:'简体中文',selectionButton:true,showSource:false,timeout:60,cache:true,prefetchScreens:-1,disabledSites:[],siteModes:{}};
const origins=[];
window.chrome={
